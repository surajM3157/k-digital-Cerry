            ...
            children: [
              ...
              Padding(
                ...
                child: TextFormField(
                  ...
                  validator: (value) {
                    if (value == null || value.trim().isEmpty) {
                      return 'Enter valid message.';  // Shows error if the input is empty or only contains spaces
                    }
                    return null;
                  },
                  decoration: InputDecoration(
...
class _ContactUsPageState extends State<ContactUsPage> {
  ...
  TextEditingController emailController = TextEditingController();
  TextEditingController phoneNumberController = TextEditingController();
  PhoneNumber _phoneNumber = PhoneNumber(isoCode: 'IN');  // Default country code as India
  final _formKey = GlobalKey<FormState>();
  bool isConnected = true;
              ...
              Padding(
                ...
                child: InternationalPhoneNumberInput(
                  ...
                  selectorConfig: const SelectorConfig(
                    selectorType: PhoneInputSelectorType.BOTTOM_SHEET, // Show country selector as a bottom sheet
                  ),
