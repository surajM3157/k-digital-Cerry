              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    ...
                    maxLines: 5, // Ensure only one line is shown
                  ),
                 ...
                 /* Text(guestDetails?.companyName ?? "",
                  ...
                  Text(
                    ...
                    style: AppThemes.subtitleTextStyle().copyWith(
                  ...
                  Text(capitalizeText(guestDetails?.designation ?? ""),
                      style: AppThemes.subtitleTextStyle()
                       ...
                       overflow: TextOverflow.ellipsis, textAlign: TextAlign.center, maxLines: 5,
                  ),
                 ...
                 /* const SizedBox(height: 7),
                  (guestDetails?.alumniOfIit ?? false)
                      ? Text(
                    '${guestDetails?.iitName ?? ""} ${guestDetails?.batch != 0
                        && guestDetails?.batch != null ? guestDetails?.batch : ""}',
                    style: AppThemes.subtitleTextStyle()
                        .copyWith(color: AppColor.FF161616, fontSize: 16),
                  )
                      : const SizedBox.shrink()*/ // If alumniOfIit is false, don't show anything
