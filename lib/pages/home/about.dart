...
class _AboutState extends State<About> with SingleTickerProviderStateMixin {
                          ...
                          children: [
                            ...
                            GridView.count(
                              ...
                              children: [
                                cardWidget(
                                    title: "2 Days\nConference",
                                    image: Images.conferenceIcon),
                                cardWidget(
                                    title: "200+\nSpeakers",
                                    image: Images.aboutSpeakersIcon),
                                cardWidget(
                                    title: "3000+\nAttendees",
                                    image: Images.attendeesIcon),
                                cardWidget(
                                    title: "Firesides",
                                    image: Images.firesidesIcon),
                                cardWidget(
                                    title: "Startup Conclave",
                                    image: Images.startupConclaveIcon),
                                cardWidget(
                                    title: "250+ Startup",
                                    image: Images.startupIcon),
                                cardWidget(
                                    title: "100+ Investors",
                                    image: Images.investorsIcon),
                                cardWidget(
                                    title: "10,000+Participants\nHackathon",
                                    image: Images.hackathonIcon),
                                cardWidget(
                                    title: "Exhibitions",
                                    image: Images.exhibitorsIcon),
                                cardWidget(
                                    title: "IIT\nRepresentatives",
                                    image: Images.representativeIcon),
                            ...
                            GridView.builder(
                              ...
                              itemBuilder: (context, index) {
                                return aboutCard(
                                  title: aboutUsData?.organisingTeam?[index]
                                          .organiserName ??
                                      "",
                                  image: aboutUsData?.organisingTeam?[index]
                                              .organiserImage !=
                                          null
                                      ? Image.network(
                                          ApiUrls.imageUrl +
                                              (aboutUsData
                                                      ?.organisingTeam?[index]
                                                      .organiserImage ??
                                                  ""),
                                          fit: BoxFit.fill)
                                      : Image.asset(Images.defaultProfile,
                                          fit: BoxFit.fill),
                                  subtitle: aboutUsData?.organisingTeam?[index]
                                          .designation ??
                                      "",
                                );
                              },
                              itemCount:
                                  aboutUsData?.organisingTeam?.length ?? 0,
                            ),
                        ...
                        child: Column(
                          ...
                          children: [
                                ...
                                child: aboutUsData?.logo != null
                                    ? Image.network(
                                        ApiUrls.imageUrl +
                                            (aboutUsData?.logo ?? ""),
                                        fit: BoxFit.fill)
                                    : Image.asset(Images.aboutBanner,
                                        fit: BoxFit.fill),
                              ),
                            ),
                            ...
                            GridView.builder(
                              ...
                              itemBuilder: (context, index) {
                                return aboutCard(
                                  title: aboutUsData?.officialBearers?[index]
                                          .bearerName ??
                                      "",
                                  image: aboutUsData?.officialBearers?[index]
                                              .bearerImage !=
                                          null
                                      ? Image.network(
                                          ApiUrls.imageUrl +
                                              (aboutUsData
                                                      ?.officialBearers?[index]
                                                      .bearerImage ??
                                                  ""),
                                          fit: BoxFit.fill)
                                      : Image.asset(Images.defaultProfile,
                                          fit: BoxFit.fill),
                                  subtitle: aboutUsData?.officialBearers?[index]
                                          .designation ??
                                      "",
                                );
                              },
                              itemCount:
                                  aboutUsData?.officialBearers?.length ?? 0,
                            ),
                            const SizedBox(height: 30),
                          ],
                        ),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            title,
            style: AppThemes.aboutCardTitleTextStyle(),
  ...
  Widget aboutCard(
      {required String title, required Image image, required String subtitle}) {
    return Container(
      padding: const EdgeInsets.all(5),
      decoration: BoxDecoration(
        borderRadius: BorderRadius.circular(15),
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            subtitle,
            style: AppThemes.aboutCardSubtitleTextStyle(),
            textAlign: TextAlign.center,
          ),
        ],
      ),
