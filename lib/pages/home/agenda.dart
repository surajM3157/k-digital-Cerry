      ...
      child: SingleChildScrollView(
                                  ...
                                  children: [
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          Container(height: 10, width: 10,
                                            decoration: BoxDecoration(color: AppColor.primaryColor, borderRadius:
                                    ...
                                    Flexible(
                                      ...
                                      child: Column(
                                        crossAxisAlignment: CrossAxisAlignment.start,
                                        children: [
                                          Text(agendaList[index].agendas?[agendasIndex].time ?? "", style: TextStyle(
                                          ...
                                          Text(agendaList[index].agendas?[agendasIndex].title ?? "",
                                            style: TextStyle(fontFamily: appFontFamily, fontSize: 14,
                                                fontWeight: FontWeight.w600,color: AppColor.FF161616),
                                          ),
                                          const SizedBox(height: 8),
                                          ListView.builder(
                                              shrinkWrap: true,
                                              physics: const NeverScrollableScrollPhysics(),
                                              itemCount: agendaList[index]
                                                  .agendas![agendasIndex]
                                                  .activities
                                                  ?.length,
                                              itemBuilder: (context, activityIndex) {
                                                return buildBulletPoint(
                                                    Text(agendaList[index].agendas![agendasIndex].activities![activityIndex], style:
                                                    TextStyle(fontWeight: FontWeight.w400, fontSize: 14,
                                                        fontFamily: appFontFamily, color: AppColor.FF161616),
                                                    ));
                                              }),
       ...
       : const Center(
        child: Text("OOPS! NO INTERNET.",
          style: TextStyle(color: Colors.black87, fontWeight: FontWeight.w600, fontFamily: appFontFamily,
              fontSize: 20),
        ));
  }
