...
class ChatService{
  ...
  Future<void> sendMessage(String receiverId, String message,String receiverName){
    ...
    Message newMessage = Message(senderId: currentUserId, senderName: currentUserName, receiverId: receiverId, message: encryptMessage(message,'my_secure_passphrase'), timestamp: timestamp, receiverName: receiverName, isRead: false);
